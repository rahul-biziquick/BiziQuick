...
const loggingMiddleware = (req, res, next) => {
  ...
  res.setHeader(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' blob:; style-src 'self' 'unsafe-inline'; connect-src *; object-src 'none';"
  );
  ...
  res.on("finish", () => {
    ...
    const message = `Response: ${req.method} ${req.originalUrl} - Status: ${
      res.statusCode
